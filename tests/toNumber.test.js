...
test('Expecting toNumber() to return NaN for a empty value', () => {
    expect(toNumber()).toBe.NaN;
})
test('Expecting toNumber() to return NaN for a value undefined', () => {
    expect(toNumber(null)).toBe.NaN;
})
test('Expecting toNumber() to return NaN for a value null', () => {
