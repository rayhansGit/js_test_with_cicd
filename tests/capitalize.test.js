...
test('Expecting capitalize() to return "Null" for a value null', () => {
    expect(capitalize(null)).toBe("Null");
})
test('Expecting capitalize() to return "Undefined" for a value undefined', () => {
    expect(capitalize(undefined)).toBe("Undefined");
})
test('Expecting capitalize() to return "Undefined" for a empty value', () => {
